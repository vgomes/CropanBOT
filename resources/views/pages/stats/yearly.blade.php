...
@section('content')
    ...
    @foreach(json_decode($data, true) as $key => $item)
        <div class="row">
            <div class="col-md-12"><h4 class="text-xs-center">{{ $key }}</h4></div>
            <div class="col-md-9">
        ...
        <script>
            ...
            var result = [{'label': 'Sí', 'value': votes.yes, 'total': votes.yes + votes.no}, {'label': 'No', 'value': votes.no, 'total': votes.yes + votes.no}];
